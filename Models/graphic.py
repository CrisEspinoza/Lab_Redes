...
## - FUNCTIONS - ##
    ...
    def generateGraphics6 (self, modulation, audio, title):
        ...
        plt.subplot(413)
        newdata, fft = self.lowpassFilteredGraphic(audio, audio.filter.low_cutoff, audio.filter.order)
        plt.subplot(414)
        graphic.inverseGraphic(modulation.freqX, fft, "demodulacion", audio.filter.low_cutoff, audio.filter.order)
        plt.tight_layout()
